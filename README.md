# Intel<sup>®</sup> Security Libraries for Data Center  - Common Libraries
#### These libraries provide common functionality used by other libraries.
...
- Git clone the `Common Libraries`
- Run scripts to build the `Common Libraries`

```shell
$ git clone https://github.com/intel-secl/lib-common.git
$ cd lib-common
$ ant
```
