 ...
 */
package com.intel.mtwilson.core.common.model.x509;
...
public class UTF8NameValueSequence extends ASN1Object {
    ...
    public UTF8NameValueSequence(ASN1Sequence sequence) {
        ...
        this.values = (ASN1Sequence) DERSequence.getInstance(sequence.getObjectAt(1)).toASN1Primitive(); //new DERSequence(sequence.getObjectAt(1));
    }
