...
public class PcrIndex extends ObjectModel {
    ...
    public PcrIndex(String pcrNumber) {
        number = Integer.valueOf(pcrNumber.replace("pcr_", ""));
    }
    ...
    public String toString() {
        return String.format("pcr_%d", number);
    }
    ...
    public static PcrIndex valueOf(String istr) {
        return valueOf(Integer.valueOf(istr.replace("pcr_", "")));
    }
}
